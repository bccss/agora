...
ActiveRecord::Schema.define(version: 20150118114246) do
  ...
  add_index "foods", ["buyer_id"], name: "index_foods_on_buyer_id", using: :btree
  ...
  add_index "transactions", ["food_id"], name: "index_transactions_on_food_id", using: :btree
